...
for f in proto/nanopb.proto proto/meshtastic/*.proto; do
  args+=("--go_opt=M${f#proto/}=github.com/A13xB0/RepeaterTastic/internal/pb;pb")
done
protoc -Iproto --go_out="$OUT" --go_opt=paths=import --go_opt=module=github.com/A13xB0/RepeaterTastic/internal/pb "${args[@]}" \
